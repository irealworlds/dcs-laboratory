...
public class FuzzyDefuzzy {
    ...
    public FuzzyToken fuzzyfie(double val) {
        ...
        } else if (val > limits.get(FuzzyValue.NL) && val <= limits.get(FuzzyValue.NM)) {
        ...
        } else if (val > limits.get(FuzzyValue.NM) && val <= limits.get(FuzzyValue.ZR)) {
        ...
        } else if (val > limits.get(FuzzyValue.ZR) && val <= limits.get(FuzzyValue.PM)) {
        ...
        } else if (val > limits.get(FuzzyValue.PM) && val <= limits.get(FuzzyValue.PL)) {
